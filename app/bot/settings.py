...
class Settings(BaseSettings):
    ...
    psql: PostgresSettings = PostgresSettings(_env_prefix="PSQL_")  # type: ignore[call-arg]
    redis: RedisSettings = RedisSettings(_env_prefix="REDIS_")  # type: ignore[call-arg]
